		...
		if mode == self.MODE_NORMAL:
			...
			if config.usage.show_event_progress_in_servicelist.value:
				if config.skin.xres.value == 1920:
					self.l.setElementPosition(self.l.celServiceEventProgressbar, eRect(80, 0, 52, self.ItemHeight))
				else:
					self.l.setElementPosition(self.l.celServiceEventProgressbar, eRect(60, 0, 52, self.ItemHeight))
			else:
				if config.skin.xres.value == 1920:
					self.l.setElementPosition(self.l.celServiceEventProgressbar, eRect(80, 0, 0, 0))
				else:
					self.l.setElementPosition(self.l.celServiceEventProgressbar, eRect(60, 0, 0, 0))
			self.l.setElementFont(self.l.celServiceNumber, self.ServiceNumberFont)
			if config.skin.xres.value == 1920:
				self.l.setElementPosition(self.l.celServiceNumber, eRect(0, 0, 70, self.ItemHeight))
			else:
				self.l.setElementPosition(self.l.celServiceNumber, eRect(0, 0, 50, self.ItemHeight))
			self.l.setElementFont(self.l.celServiceName, self.ServiceNameFont)
			if config.skin.xres.value == 1920:
				self.l.setElementPosition(self.l.celServiceName, eRect(80, 0, self.instance.size().width()-80, self.ItemHeight))
			else:
